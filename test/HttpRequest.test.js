const httpRequests = require("../index");
const chai = require("chai");
const querystring = require("querystring");
const { server, VALID_URL, CUSTOM_ERROR_NAME, OBJECT_ERROR_URL, STRING_ERROR_URL } = require("./app");
...
describe("Http request promise simple", () => {
  ...
  describe(`GET Requests`, () => {
    it("it should make a GET request successfully", async function() {
      ...
      res.reqQueryString.should.be.eql(PARSED_QUERYSTRING);
  ...
  describe(`Data parsing for Requests`, () => {
    it("it should make a POST request successfully with data being an object", async function() {
      ...
      res.reqBody.foo.should.be.eql("fighters");
      res.reqBody.is.should.be.eql("an");
      res.reqBody.awesome.should.be.eql("band");
    });
  });
